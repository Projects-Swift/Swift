...
class Square: NamedShape {
    ...
    override func simpleDescripation() -> String {
...
print(triangle.sideLength,triangle.perimeter)
...
print(triangleAndSquare.triangle.sideLength,triangleAndSquare.square.sideLength)
